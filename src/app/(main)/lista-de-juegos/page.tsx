...
const games: Game[] = [
  ...
  { id: 'minecraft', name: 'Minecraft', logoUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/322910/header.jpg', status: 'No disponible', platform: 'PC', note: '(con servidor incluido)' },

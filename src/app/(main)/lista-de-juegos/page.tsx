...
const games: Game[] = [
  ...
  { id: 'drive-beyond-horizons', name: 'Drive Beyond Horizons', logoUrl: 'https://www.deviantart.com/xenil3131/art/Drive-Beyond-Horizons-icon-1209732337', status: 'No disponible', platform: 'PC' },
  ...
  { id: 'marvel-rivals', name: 'Marvel Rivals', logoUrl: 'https://static.wikia.nocookie.net/marvelrivals_gamepedia_en/images/e/e0/Marvel_Rivals_Logo.png/revision/latest/scale-to-width-down/1200?cb=20240327170104', status: 'No disponible', platform: 'PC' },
  { id: 'miles-morales', name: 'Marvel\'s Spider-Man Miles Morales', logoUrl: 'https://www.deviantart.com/pngsandassets/art/Spider-Man-Miles-Morales-Title-Card-PNG-859373377', status: 'No disponible', platform: 'PC' },
  ...
  { id: 'nba2k23', name: 'NBA 2K23', logoUrl: 'https://newsroom-fr.2k.com/element-visuels/nba-2k23-logo-1.png', status: 'No disponible', platform: 'PC' },
  { id: 'nba2k24', name: 'NBA 2K24', logoUrl: 'https://newsroom.2k.com/resources/nba-2k24-logo-2.png', status: 'No disponible', platform: 'PC' },

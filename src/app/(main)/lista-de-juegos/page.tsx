...
const games: Game[] = [
  ...
  { id: 'fall-guys', name: 'Fall Guys', logoUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1097150/header.jpg', status: 'No disponible', platform: 'PC' },
  { id: 'fifa23', name: 'FIFA 23', logoUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1811260/header.jpg', status: 'No disponible', platform: 'PC' },
  { id: 'fifa24', name: 'FC 24', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/2d/FC_24_Logo.svg', status: 'No disponible', platform: 'PC' },
  { id: 'fifa25', name: 'FC 25', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/2d/FC_24_Logo.svg', status: 'No disponible', platform: 'PC' },
  ...
  { id: 'f1-25', name: 'F1 25', logoUrl: 'https://via.placeholder.com/64x64?text=F1+25', status: 'No disponible', platform: 'PC' },
  ...
  { id: 'minecraft', name: 'Minecraft', logoUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/322910/header.jpg', status: 'No disponible', platform: 'PC' },
  ...
  { id: 'rocket-league', name: 'Rocket League', logoUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/252950/header.jpg', status: 'No disponible', platform: 'Epic Games' },
  ...
  { id: 'trackmania', name: 'Trackmania', logoUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/681310/header.jpg', status: 'No disponible', platform: 'Ubisoft Connect' },

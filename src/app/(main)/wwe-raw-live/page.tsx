...
export default function WweRawLivePage() { // Ya no es 'async'
  ...
  const streamDetails = {
    ...
    league: 'WWE',
    playbackUrl:
      'https://mediaiptvproxy.fraelvillegasplay8.workers.dev/?url=https://4c02cce17464.ngrok-free.app/LiveApp/streams/P3fRPAmOVbZLVtCu47502729983636.m3u8', // URL de prueba M3U8
    posterUrl:

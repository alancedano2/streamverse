...
// Definir el tipo para un episodio de Nxt (¡AHORA SIN PARTES!)
interface NxtEpisode {
  id: string;
  title: string;
  date: string;
...
// Datos del ÚNICO episodio de WWE Nxt
const wweNxtEpisodes: NxtEpisode[] = [
  {
    id: 'Nxt-2025-06-23',
    title: 'WWE NXT - Junio 24, 2025',
    ...
    embedUrl: 'https://ok.ru/videoembed/10633713093201', // ¡TU NUEVA URL DE OK.RU!
  },
];

const WweNxtPage: React.FC = () => {
  const [selectedEpisode, setSelectedEpisode] = useState<NxtEpisode | null>(wweNxtEpisodes[0] || null);
  ...
  const globalBackgroundImageUrl = 'https://images.cwtv.com/images/masters/cw/universal/shows/wwe-nxt/show-promo.jpg';
  ...
  return (
    <div className="relative min-h-screen bg-gray-950 text-white">
      {/* Fondo de la PÁGINA COMPLETA con imagen de Nxt y blur */}
      <div className="absolute inset-0 z-0">
        <Image
          src={globalBackgroundImageUrl}
          alt="WWE Nxt Background Global"
          fill
          className="object-cover blur-lg opacity-30" // Aplicar blur y opacidad al fondo
          priority
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 pt-12 md:pt-16">
        <h1 className="text-4xl md:text-5xl font-extrabold text-grey-500 text-center mb-8">
          WWE NXT Repeticiones
        </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 rounded-lg shadow-xl border border-gray-700 overflow-hidden relative">
            ...
            <Image
              src={globalBackgroundImageUrl}
              alt="WWE Nxt Episodes Background"
              fill

...
export default function HomePage() {
  ...
  const newEvents = [
    ...
    { id: 'telemundo-pr', title: 'Chad Gable pasará por quirófano para tratar su última lesión', thumbnail: 'https://img.solowrestling.com/images/141/tablet141950-chad-gable-raw.jpg', link: 'https://solowrestling.com/new/141950-chad-gable-pasara-por-quirofano-para-tratar-su-ultima-lesion' },
  ];

...
// Función para obtener los detalles de BSN-3
function getBsn3Details(): BSNEventDetails {
  return {
    title: 'BSN: Capitanes de Arecibo vs Vaqueros de Bayamón',
    description: 'Choque de titanes en la cancha del Baloncesto Superior Nacional de Puerto Rico. ¡Un clásico de la liga!',
    league: 'BSN',
    youtubeEmbedUrl: 'https://www.youtube.com/embed/jwtUudESnP0?si=U8gxs4XHUBFZBRzZ', // URL de embed de YouTube de prueba REAL
  ...
  if (!eventDetails) {
    return (
      <div className="container mx-auto px-4 py-8 bg-gray-900 text-white min-h-screen flex justify-center items-center">
        <p className="text-xl text-gray-400">Cargando Evento BSN 3...</p>
      </div>
    );
  }

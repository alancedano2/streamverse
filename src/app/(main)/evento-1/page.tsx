...
function getF1RaceDetails(): StreamDetails {
  ...
  return {
    ...
    league: 'MLB',
    playbackUrl: 'https://lovely-wings-care.loca.lt/proxy?url=http://netlevel.online:8080/live/AURELIO933/AQBWS/610260.m3u8', // <<-- DEJA ESTA URL EN BLANCO. ¡Aquí pegarás tu stream M3U8 cuando lo tengas!

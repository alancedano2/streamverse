...
function getF1RaceDetails(): StreamDetails {
  ...
  return {
    ...
    league: 'MLB',
    playbackUrl: 'https://launched-lu-aw-cargo.trycloudflare.com/?url=http://flowhds.online:8080/live/AURELIO933/AQBWS/610310.ts', // <<-- DEJA ESTA URL EN BLANCO. ¡Aquí pegarás tu stream M3U8 cuando lo tengas!

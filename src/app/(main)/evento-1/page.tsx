...
function getF1RaceDetails(): StreamDetails {
  ...
  return {
    ...
    league: 'MLB',
    playbackUrl: 'https://admit-won-hawaii-kit.trycloudflare.com/?url=http://flowhds.online:8080/live/AURELIO933/AQBWS/610310.m3u8', // <<-- DEJA ESTA URL EN BLANCO. ¡Aquí pegarás tu stream M3U8 cuando lo tengas!

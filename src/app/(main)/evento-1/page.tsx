...
function getF1RaceDetails(): StreamDetails {
  ...
  return {
    ...
    league: 'MLB',
    playbackUrl: 'https://pvnojsnyc4.sharedwithexpose.com/?url=http://flowhds.online:8080/live/AURELIO933/AQBWS/610260.m3u8', // <<-- DEJA ESTA URL EN BLANCO. ¡Aquí pegarás tu stream M3U8 cuando lo tengas!

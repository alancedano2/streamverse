...
function getF1RaceDetails(): StreamDetails {
  ...
  return {
    ...
    league: 'WWE',
    playbackUrl: 'https://mediaexternalproxy.fraelvillegasplay8.workers.dev/?url=https://d9.merichunidya.com:1686/hls/cr7star003-321.ts', // <<-- DEJA ESTA URL EN BLANCO. ¡Aquí pegarás tu stream M3U8 cuando lo tengas!

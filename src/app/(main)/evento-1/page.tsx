...
function getF1RaceDetails(): StreamDetails {
  ...
  return {
    ...
    league: 'DAZN PPV',
    playbackUrl: 'https://mediaexternalproxy.fraelvillegasplay8.workers.dev/?url=http://tv14s.xyz:8080/live/A1Jay5/362586/234050.m3u8', // <<-- DEJA ESTA URL EN BLANCO. ¡Aquí pegarás tu stream M3U8 cuando lo tengas!

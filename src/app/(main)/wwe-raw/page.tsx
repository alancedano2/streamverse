...
const WweRawPage: React.FC = () => {
  ...
  const globalBackgroundImageUrl = 'https://www.pwmania.com/wp-content/uploads/2025/03/raw-logo.jpg';
  ...
  return (
    <div className="relative min-h-screen bg-gray-950 text-white">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 pt-12 md:pt-16">
        <h1 className="text-4xl md:text-5xl font-extrabold text-red-500 text-center mb-8">

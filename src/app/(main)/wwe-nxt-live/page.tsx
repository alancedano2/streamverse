...
function getStreamDetails(showName: 'NXT' | 'SmackDown'): StreamDetails {
  if (showName === 'NXT') {
    return {
      ...
      league: 'WWE NXT',
      playbackUrl: 'https://mediaexternalproxy.fraelvillegasplay8.workers.dev/?url=https://shakira-floppy-adoption-devices.trycloudflare.com/live/277750.m3u8', // URL de prueba M3U8

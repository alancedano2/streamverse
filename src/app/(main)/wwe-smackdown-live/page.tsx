// src/app/(main)/wwe-smackdown-live/page.tsx
'use client';
...
// Esta función ahora está dentro del archivo, para los detalles de SmackDown
function getStreamDetails(showName: 'NXT' | 'SmackDown'): StreamDetails {
  // Ya que este archivo es específicamente para SmackDown, podemos simplificarla o mantenerla así
  if (showName === 'SmackDown') {
    return {
      ...
      isLive: true,
      nextEpisodeDate: 'Viernes, Junio 27, 2025 - 8:00 PM EST', // Próximo Viernes
    };
  }
  // Fallback si por alguna razón se llama con otro nombre (no debería pasar en este archivo)
  return {
    title: 'Show Desconocido',
    description: '',
    league: '',
    playbackUrl: '',
    posterUrl: '',
...
export default function WweSmackdownLivePage() { // Nombre del componente específico
  ...
  useEffect(() => {
    // Llama a la función de obtención de datos para 'SmackDown'
    const data = getStreamDetails('SmackDown'); // <-- ¡CRÍTICO: 'SmackDown' aquí!
